...
import pe.area51.notepad.persistence.SQLiteManager;

public class NotesContentProvider extends ContentProvider {

    public static final Uri URI = Uri.parse("content://pe.area51.notepad.NotepadProvider");
    ...
    public Uri insert(Uri uri, ContentValues values) {
        if (uriMatcher.match(uri) != UriMatcher.NO_MATCH) {
            ...
            return ContentUris.withAppendedId(NotesContract.URI, id);
        }
        return null;
    }
